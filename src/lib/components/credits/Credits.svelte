<div class="text-2xs text-earth/80 mt-3 flex flex-col gap-2 font-sans leading-tight sm:mt-4">
	<p class="m-0">
		<strong>Note</strong> Data is current as of the city’s 2025 water service line inventory. The city’s data is incomplete and might contain inaccuracies and duplicates. Multiple addresses might be served by the same service line. Some addresses will appear as ranges. We encourage users to independently verify any information before acting on it.
	</p>
	<p class="m-0">
